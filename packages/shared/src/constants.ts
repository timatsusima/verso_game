...
export const TRANSLATIONS = {
  ru: {
    ...
    victory: 'Победа!',
    defeat: 'Поражение',
    // Duel PvP enhancements
    thinking: 'думает...',
    answered: 'ответил',
    didntAnswer: 'не успел',
    answeredFirst: 'первым',
    opponentAnsweredFirst: 'Соперник ответил первым!',
    youHave10Seconds: 'У ТЕБЯ 10 СЕКУНД!',
    hurryUpToast: '⚡ Поторапливайся!',
    opponentPickedAnswer: 'Соперник выбрал ответ',
    whoWasFaster: 'Кто быстрее',
    yourTime: 'Ты',
    opponentTime: 'Соперник',
    noAnswer: 'нет ответа',
    youAnsweredFirst: 'Ты ответил первым!',
    waitingForOpponentAnswer: 'Ждём ответ соперника...',
  },
  en: {
    ...
    thinking: 'thinking...',
    answered: 'answered',
    didntAnswer: 'no answer',
    answeredFirst: 'first',
    opponentAnsweredFirst: 'Opponent answered first!',
    youHave10Seconds: 'YOU HAVE 10 SECONDS!',
    hurryUpToast: '⚡ Hurry up!',
    opponentPickedAnswer: 'Opponent picked an answer',
    whoWasFaster: 'Who was faster',
    yourTime: 'You',
    opponentTime: 'Opponent',
    noAnswer: 'no answer',
    youAnsweredFirst: 'You answered first!',
